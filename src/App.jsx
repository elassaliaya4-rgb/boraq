        ...
        <div className="splash-3d-track">
          <div className="splash-3d-rmook">
            <svg width="100" height="46" viewBox="0 0 135 56" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <rect x="18" y="10" width="65" height="30" rx="3" fill="url(#trailer3d)" stroke="rgba(56, 189, 248, 0.5)" strokeWidth="1.5" />
              ...
              <path d="M86 16 H104 C108 16 112 20 114 25 L118 32 C119 34 119 40 119 40 H86 V16 Z" fill="url(#cab3d)" stroke="#f59e0b" strokeWidth="1.2" />
              
              {/* 3D Windshield Glass */}
              <path d="M96 19 H105 L110 27 H96 V19 Z" fill="#0f172a" stroke="#38bdf8" strokeWidth="1" opacity="0.9" />

              {/* Glowing Headlight & Beam */}
              <circle cx="117" cy="35" r="2.5" fill="#fef08a" filter="url(#headlightGlow)" />
              <polygon points="117,33 135,28 135,42 117,37" fill="rgba(254, 240, 138, 0.2)" />

              {/* 3D Wheels (Chrome Rims) */}
              <circle cx="30" cy="42" r="6" fill="url(#wheel3d)" stroke="#38bdf8" strokeWidth="1.2" />
              <circle cx="30" cy="42" r="2" fill="#38bdf8" />

              <circle cx="44" cy="42" r="6" fill="url(#wheel3d)" stroke="#38bdf8" strokeWidth="1.2" />
              <circle cx="44" cy="42" r="2" fill="#38bdf8" />

              <circle cx="68" cy="42" r="6" fill="url(#wheel3d)" stroke="#f59e0b" strokeWidth="1.2" />
              <circle cx="68" cy="42" r="2" fill="#f59e0b" />

              <circle cx="102" cy="42" r="6" fill="url(#wheel3d)" stroke="#f59e0b" strokeWidth="1.2" />
